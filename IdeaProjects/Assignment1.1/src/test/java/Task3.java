...
/*
        WebElement telephoneInput = driver.findElement(By.xpath("//input[@id='input-telephone']"));
...
/*
        WebElement ConfirmPasswordInput = driver.findElement(By.xpath("//input[contains(@id, 'input-confirm') or @type='password']"));
